...
export const HERMES_PROVIDERS: HermesProviderDef[] = [
  ...
  { type: 'novita', label: 'NovitaAI', description: '200+ models', authType: 'api-key', envVar: 'NOVITA_API_KEY', defaultBaseUrl: 'https://api.novita.ai/v3/openai' },
  { type: 'ai-gateway', label: 'AI Gateway', description: 'AI Gateway API', authType: 'api-key', envVar: 'AI_GATEWAY_API_KEY', defaultBaseUrl: 'https://api.ai-gateway/v1' },
  { type: 'zai', label: 'z.ai / GLM', description: 'GLM API', authType: 'api-key', envVar: 'GLM_API_KEY', defaultBaseUrl: 'https://open.bigmodel.cn/api/paas/v4' },
  { type: 'kimi', label: 'Kimi / Moonshot', description: 'Kimi API', authType: 'api-key', envVar: 'KIMI_API_KEY', defaultBaseUrl: 'https://api.moonshot.cn/v1' },
  { type: 'kimi-cn', label: 'Kimi China', description: 'Kimi China endpoint', authType: 'api-key', envVar: 'KIMI_CN_API_KEY', defaultBaseUrl: 'https://api.moonshot.cn/v1' },
  { type: 'arcee', label: 'Arcee AI', description: 'Arcee AI API', authType: 'api-key', envVar: 'ARCEEAI_API_KEY', defaultBaseUrl: 'https://api.arcee.ai/v1' },
  { type: 'gmi', label: 'GMI Cloud', description: 'GMI API', authType: 'api-key', envVar: 'GMI_API_KEY', defaultBaseUrl: 'https://api.gmi.cloud/v1' },
  { type: 'minimax', label: 'MiniMax', description: 'MiniMax API', authType: 'api-key', envVar: 'MINIMAX_API_KEY', defaultBaseUrl: 'https://api.minimax.chat/v1' },
  { type: 'minimax-cn', label: 'MiniMax China', description: 'MiniMax China endpoint', authType: 'api-key', envVar: 'MINIMAX_CN_API_KEY', defaultBaseUrl: 'https://api.minimax.chat/v1' },
  { type: 'alibaba', label: 'Alibaba Cloud', description: 'Dashscope API', authType: 'api-key', envVar: 'DASHSCOPE_API_KEY', defaultBaseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1' },
  { type: 'alibaba-coding', label: 'Alibaba Coding Plan', description: 'Separate billing', authType: 'api-key', envVar: 'DASHSCOPE_API_KEY', defaultBaseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1' },
  { type: 'kilocode', label: 'Kilo Code', description: 'Kilo Code API', authType: 'api-key', envVar: 'KILOCODE_API_KEY', defaultBaseUrl: 'https://api.kilocode.ai/v1' },
  { type: 'xiaomi', label: 'Xiaomi MiMo', description: 'Xiaomi MiMo API', authType: 'api-key', envVar: 'XIAOMI_API_KEY', defaultBaseUrl: 'https://api.xiaomi.com/v1' },
  { type: 'tencent-tokenhub', label: 'Tencent TokenHub', description: 'Tencent MaaS API', authType: 'api-key', envVar: 'TOKENHUB_API_KEY', defaultBaseUrl: 'https://api.tokenhub.tencent.com/v1' },
  { type: 'opencode-zen', label: 'OpenCode Zen', description: 'OpenCode Zen API', authType: 'api-key', envVar: 'OPENCODE_ZEN_API_KEY', defaultBaseUrl: 'https://api.opencode.dev/v1' },
  { type: 'opencode-go', label: 'OpenCode Go', description: 'OpenCode Go API', authType: 'api-key', envVar: 'OPENCODE_GO_API_KEY', defaultBaseUrl: 'https://api.opencode.dev/v1' },
  ...
  { type: 'huggingface', label: 'Hugging Face', description: 'HF Inference API', authType: 'api-key', envVar: 'HF_TOKEN', defaultBaseUrl: 'https://api-inference.huggingface.co/v1' },
