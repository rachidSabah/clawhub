...
const HERMES_PROVIDERS = [
  ...
  { name: 'NovitaAI', type: 'novita', authType: 'api-key', envVar: 'NOVITA_API_KEY', baseUrl: 'https://api.novita.ai/v3/openai', description: '200+ models, Model API, Agent Sandbox, GPU Cloud' },
  { name: 'AI Gateway', type: 'ai-gateway', authType: 'api-key', envVar: 'AI_GATEWAY_API_KEY', baseUrl: 'https://api.ai-gateway/v1', description: 'AI Gateway API' },
  { name: 'z.ai / GLM', type: 'zai', authType: 'api-key', envVar: 'GLM_API_KEY', baseUrl: 'https://open.bigmodel.cn/api/paas/v4', description: 'GLM API' },
  { name: 'Kimi / Moonshot', type: 'kimi', authType: 'api-key', envVar: 'KIMI_API_KEY', baseUrl: 'https://api.moonshot.cn/v1', description: 'Kimi API' },
  { name: 'Kimi / Moonshot (China)', type: 'kimi-cn', authType: 'api-key', envVar: 'KIMI_CN_API_KEY', baseUrl: 'https://api.moonshot.cn/v1', description: 'Kimi China endpoint' },
  { name: 'Arcee AI', type: 'arcee', authType: 'api-key', envVar: 'ARCEEAI_API_KEY', baseUrl: 'https://api.arcee.ai/v1', description: 'Arcee AI API' },
  { name: 'GMI Cloud', type: 'gmi', authType: 'api-key', envVar: 'GMI_API_KEY', baseUrl: 'https://api.gmi.cloud/v1', description: 'GMI API' },
  { name: 'MiniMax', type: 'minimax', authType: 'api-key', envVar: 'MINIMAX_API_KEY', baseUrl: 'https://api.minimax.chat/v1', description: 'MiniMax API' },
  { name: 'MiniMax China', type: 'minimax-cn', authType: 'api-key', envVar: 'MINIMAX_CN_API_KEY', baseUrl: 'https://api.minimax.chat/v1', description: 'MiniMax China endpoint' },
  { name: 'Alibaba Cloud', type: 'alibaba', authType: 'api-key', envVar: 'DASHSCOPE_API_KEY', baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1', description: 'Dashscope API' },
  { name: 'Alibaba Coding Plan', type: 'alibaba-coding', authType: 'api-key', envVar: 'DASHSCOPE_API_KEY', baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1', description: 'Separate billing SKU, different endpoint' },
  { name: 'Kilo Code', type: 'kilocode', authType: 'api-key', envVar: 'KILOCODE_API_KEY', baseUrl: 'https://api.kilocode.ai/v1', description: 'Kilo Code API' },
  { name: 'Xiaomi MiMo', type: 'xiaomi', authType: 'api-key', envVar: 'XIAOMI_API_KEY', baseUrl: 'https://api.xiaomi.com/v1', description: 'Xiaomi MiMo API' },
  { name: 'Tencent TokenHub', type: 'tencent-tokenhub', authType: 'api-key', envVar: 'TOKENHUB_API_KEY', baseUrl: 'https://api.tokenhub.tencent.com/v1', description: 'Tencent MaaS API' },
  { name: 'OpenCode Zen', type: 'opencode-zen', authType: 'api-key', envVar: 'OPENCODE_ZEN_API_KEY', baseUrl: 'https://api.opencode.dev/v1', description: 'OpenCode Zen API' },
  { name: 'OpenCode Go', type: 'opencode-go', authType: 'api-key', envVar: 'OPENCODE_GO_API_KEY', baseUrl: 'https://api.opencode.dev/v1', description: 'OpenCode Go API' },
  ...
  { name: 'Hugging Face', type: 'huggingface', authType: 'api-key', envVar: 'HF_TOKEN', baseUrl: 'https://api-inference.huggingface.co/v1', description: 'HF Inference API' },
